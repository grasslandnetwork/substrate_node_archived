...
/// Import the wavefunction pallet.
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic,
	{
		...
		Sudo: pallet_sudo,
		// Include the custom logic from the pallet-wavefunction in the runtime.
        WavefunctionModule: pallet_wavefunction,
	}
);
...
mod benches {
	define_benchmarks!(
		...
		[pallet_template, WavefunctionModule]
	);
}
